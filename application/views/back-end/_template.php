...
<head>
  ...
  <title>SIG Instasi Sekolah & Universitas</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=base_url().'dashboard/' ?>" class="logo">
          ...
          <span class="logo-lg"><b>SIG</b> Instansi Sekolah & Universitas</span>
        </a>
    </header>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016</strong> <a href="<?=base_url() ?>">Sistem Informasi Geografis Instansi Sekolah & Universitas</a>. All rights
        reserved.
    </footer>
